...
public class GuiUtil {
	...
	public static String setKonLoad(String name) {
		return loadName(name, "png");
	}

	private static String loadName(String name, String ext) {
		String path = "/KonImg/" + name + "." + ext.toLowerCase();
		return loadNamePath(path);
	}

	private static String loadNamePath(String path) {
		String url = GuiUtil.class.getResource(path).getPath();
		return url;
	}
