...
public class DroidAtScreenApplication implements Application, AndroidDeviceListener {
	...
	//oggerFactory.getLogger(DroidAtScreenApplication.class);
	...
	public static void main(String[] args) {
        ...
        configurationDirectory = new File(configurationDirectory, ".bakasMacro");
        ...
        // to configure itself.
        log = LoggerFactory.getLogger(DroidAtScreenApplication.class);
